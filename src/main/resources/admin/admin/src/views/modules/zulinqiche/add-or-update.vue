  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qichebianhao" label="汽车编号" prop="qichebianhao">
              <el-input v-model="ruleForm.qichebianhao" 
                placeholder="汽车编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="提车地点" prop="tichedidian">
          <el-input v-model="ruleForm.tichedidian" 
              placeholder="提车地点" clearable  :readonly="ro.tichedidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="提车地点" prop="tichedidian">
              <el-input v-model="ruleForm.tichedidian" 
                placeholder="提车地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qichexiangqing = true;
          ...
          if(o=='tichedidian'){
            this.ruleForm.tichedidian = obj[o];
	    this.ro.tichedidian = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.qichexiangqing = this.ruleForm.qichexiangqing.replace(reg,'../../../springboot3x0bo/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zulinqiche/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zulinqicheCrossAddOrUpdateFlag = false;
						 this.parent.search();
